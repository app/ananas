#!/usr/bin/env bash
# Phase 2 smoke harness: build ananas-legacy-qt4 in the Qt5 container and run
# the QtTest suite headlessly under Xvfb.
#
# The tree is cleaned of previous (Qt4) build artifacts first, because the
# generated Makefiles/objects from the trusty image are not reusable.
#
# Usage: smoke-qt5.sh [path-to-ananas-legacy-qt4]
set -euo pipefail
